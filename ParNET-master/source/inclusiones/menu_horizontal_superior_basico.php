...
<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
  <a class="btn btn-success" href="registro_cursos.php">Registro</a>
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu drop-ajustes" aria-labelledby="dropdown04">
          <a class="dropdown-item" href="lista_servicios.php">Cambios servicios</a>
          <a class="dropdown-item" href="lista_clientes.php">Cambios clientes</a>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu drop-catalogo" aria-labelledby="dropdown04">
          <a class="dropdown-item" href="catalogo_areas.php">Catalogo de áreas</a>
        </div>
      </li>
