...
<body>
    <div class="container-fluid">
        <div class="row">
            <?php
            include_once "../source/inclusiones/menu_horizontal_superior_basico.php";
            ?>
        </div>
    </div>
    ...
    <div class="container-fluid" style="margin-top: 65px !important;">
        ...
        <?php
        include("model/class_lista_aspirantes_cursos_dal.php");
        $obj_lista_aspirantes_cursos = new lista_servicios_areas_dal;
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <button class='ver btn btn-warning btn-sm' id='ver_<?= $value->rfc ?>' data-rfc='<?= $value->rfc ?>' data-curso='<?= $value->id_curso ?>'>Ver</button>
                                </td>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#add').click(function() {
                ...
                window.location.href = 'registro_cursos.php';
            });


            $('#insert_form').on("submit", function(event, table) {
                // alert("intentas actualizar");
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" id="insert_form">
                    ...
                    $obj_lista_cursos = new catalogo_area_dal;
                    $lista_cursos = $obj_lista_cursos->obtener_lista_areas();
                    /*
echo '<pre>';
...
*/
                    ...
                    ?>
                        ...
                        <select name="scurso" id="scurso" class="form-control">
                            ...
                            ?>
                                <option value="<?= $value->getIDAREA(); ?>"><?= $value->getNOMBREAREA(); ?></option>
